...
function Top_LSTM.net(loader, opt)
  ...
  local class_n = opt.class_size
  local top_lstm = LSTM.lstm(loader.vocab_size, opt.top_lstm_size, opt.top_num_layers, opt.dropout)

  local top_bilstm = LSTM.lstm(loader.vocab_size, opt.top_lstm_size, opt.top_num_layers, opt.dropout)
